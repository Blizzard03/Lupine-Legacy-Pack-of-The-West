...
namespace TMPro.Examples
{
    ...
    public partial class TMP_TextSelector_A : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            ...
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextMeshPro.rectTransform, Input.mousePosition, Camera3D.main))
            {
            ...
            if (m_isHoveringObject)
            {
                ...
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextMeshPro, Input.mousePosition, Camera3D.main, true);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextMeshPro, Input.mousePosition, Camera3D.main);
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    wordPOS = Camera3D.main.WorldToScreenPoint(wordPOS);
