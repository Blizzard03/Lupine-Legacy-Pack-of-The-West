...
namespace TMPro.Examples
{
    ...
    public partial class TMPro_InstructionOverlay : MonoBehaviour
    {
        ...
        private const string instructions = "Camera3D Control - <#ffff00>Shift + RMB\n</color>Zoom - <#ffff00>Mouse wheel.";

        private TextMeshPro m_TextMeshPro;
        private TextContainer m_textContainer;
        private Transform3D m_frameCounter_transform;
