...
namespace TMPro
{
    ...
    public partial class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [Serializable]
        public partial class CharacterSelectionEvent : UnityEvent<char, int> { }

        [Serializable]
        public partial class SpriteSelectionEvent : UnityEvent<char, int> { }

        [Serializable]
        public partial class WordSelectionEvent : UnityEvent<string, int, int> { }

        [Serializable]
        public partial class LineSelectionEvent : UnityEvent<string, int, int> { }

        [Serializable]
        public partial class LinkSelectionEvent : UnityEvent<string, string, int> { }
        ...
        void LateUpdate()
        {
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, Input.mousePosition, m_Camera))
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex)
                {
                    ...
                    else if (elementType == TMP_TextElementType.Sprite2D)
